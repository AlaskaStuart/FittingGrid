"""
This module contains functions for fitting grids to data points.
"""
...
if __name__ == "__main__":
    ...
    demo_points = np.genfromtxt("./data/coords.csv", delimiter=",")

    # step-1: finding the top two theta
    hough_space = hough_transform(demo_points)
    ...
    centre = np.mean(demo_points, axis=0)
    points_centered = demo_points - centre
